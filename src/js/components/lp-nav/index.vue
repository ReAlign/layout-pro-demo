    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
        <div class="navbar-inner">
            <div class="container-fluid">
                ...
                <a class="brand" href="#">
                    Layout-pro<span class="label">DEMO</span>
                </a>
                <div class="nav-collapse collapse">
                    <ul class="nav" id="menu-layoutit">
                        ...
                        <li>
                            <div class="btn-group">
                                <a class="btn btn-primary" href="https://github.com/ReAlign/layout-pro-demo" target="_blank">
                                    <i class="icon-home icon-white"></i>首页</a>
                            </div>
                    ...
                    <ul class="nav pull-right">
                        <li>
                            <div class="btn-group">
                                <span>
                                    <iframe class="github-btn" src="http://ghbtns.com/github-btn.html?user=justjavac&repo=layoutit&type=watch&count=true" allowtransparency="true"
                                        frameborder="0" scrolling="0" width="80px" height="20px"></iframe>
                                </span>
                                <span>
                                    <iframe class="github-btn" src="http://ghbtns.com/github-btn.html?user=justjavac&repo=layoutit&type=fork&count=true" allowtransparency="true"
                                        frameborder="0" scrolling="0" width="80px" height="20px"></iframe>
                                </span>
                            </div>
                        </li>
